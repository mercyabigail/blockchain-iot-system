...
try:
    ...
    if "Device revoked" in error:
        print("Reason: Device has been revoked.")

    elif "Device not registered" in error:
        print("Reason: Device is not registered.")
